...
/**
 * The {@link TokenNameFinderModel} is the model used by a learnable
...
//TODO: Extend this one with beam size!
 ...
 public NameModel(String languageCode, MaxentModel nameFinderModel,
  ...
  private void init(Object nameFinderModel, byte[] generatorDescriptor,
    ...
    Properties manifest = (Properties) artifactMap.get(MANIFEST_ENTRY);
    manifest.put(SEQUENCE_CODEC_CLASS_NAME_PARAMETER, seqCodec.getClass()
        .getName());
  ...
  protected Class<? extends BaseToolFactory> getDefaultFactory() {
    return NameClassifierFactory.class;
  }

  public NameClassifierFactory getFactory() {
    return (NameClassifierFactory) this.toolFactory;
  }
